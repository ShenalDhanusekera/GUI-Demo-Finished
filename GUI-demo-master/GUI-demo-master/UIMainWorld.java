...
{AD
    ...
    private void testActors()
    {
         ...
         *          you want
         */
        Label label = new Label("Click Here", 35);
         ...
         */
        TextBox textbox = new TextBox("Hey There", 24,true,Color.BLUE,Color.YELLOW);
         ...
         */
        Menu menu = new Menu("Menu", "New \n Open \n Save \n Close \n Exit \n", 18, Color.BLUE, Color.YELLOW, Color.RED, Color.BLACK, new FileCommands());
